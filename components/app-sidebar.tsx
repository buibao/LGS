  ...
  return (
    <aside className="surface-panel w-full rounded-[34px] border border-white/70 p-4 text-[var(--sidebar-foreground)] shadow-[0_26px_60px_-44px_rgba(15,23,42,0.22)] md:sticky md:top-5 md:w-76 md:self-start">
          ...
          <div className="space-y-3">
            <div className="flex items-center gap-3">
                ...
                <div>
                  ...
                  <h2 className="mt-1 text-[1.3rem] font-bold leading-tight text-slate-950">{organizationName}</h2>
                </div>
              </div>
            <p className="text-[0.95rem] leading-7 text-slate-600">{tShell("sidebarDescription")}</p>
          </div>
      ...
      <div className="mt-6 rounded-[26px] border bg-white/95 p-4">
        ...
        <p className="mt-3 text-[0.94rem] leading-7 text-slate-600">{tShell("weeklyFocusDescription")}</p>
      </div>
      ...
      <div className="mt-4 rounded-[26px] border border-[var(--primary)]/10 bg-[var(--primary)]/[0.04] p-4">
        ...
        <p className="mt-2 text-[0.94rem] leading-7 text-slate-600">{tShell("automationDescription")}</p>
      </div>
    </aside>
  );
}
