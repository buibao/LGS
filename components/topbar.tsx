        ...
        <div className="flex items-start gap-3">
          ...
          <div>
            ...
            <div className="mt-1 flex flex-wrap items-center gap-2">
              <h2 className="text-[1.35rem] font-bold text-slate-950">{organizationName}</h2>
              <Badge variant="info">{role}</Badge>
              <Badge variant="neutral">{tShell("livePipeline")}</Badge>
            </div>
            <p className="mt-2 text-[0.95rem] leading-7 text-slate-500">{tShell("topbarDescription")}</p>
          </div>
        </div>
        <div className="flex flex-wrap items-center gap-3">
          <div className="hidden items-center gap-2 rounded-full border bg-[var(--secondary)]/60 px-3 py-2 text-[0.94rem] text-slate-600 lg:flex">
